...
class Jenkins_Server_and_Job_Selector:
	...
	def get_last_successful_build_job_number():
	...
	def get_last_successful_build_job_name():
        	get_successful_job_info_number = server.get_job_info('%s' % jobPipelineName)['lastSuccessfulBuild']['number']
	...
	def get_last_successful_build_job_result():
	...
	def get_last_unsuccessful_build_job_number():
	...
	def get_last_unsuccessful_build_job_name():
        	get_unsuccessful_job_info_number = server.get_job_info('%s' % jobPipelineName)['lastUnsuccessfulBuild']['number']
	...
	def get_last_unsuccessful_build_job_result():
	...
	def get_last_failed_build_job_number():
	...
	def get_last_failed_build_job_name():
        	get_failed_job_info_number = server.get_job_info('%s' % jobPipelineName)['lastFailedBuild']['number']
	...
	def get_last_failed_build_job_result():
	...
	def get_job_health_report_score():
	...
	def get_job_health_report_description():
        	get_job_health_info = server.get_job_info('%s' % jobPipelineName)['healthReport']
